...
you can freely choose from 0-65535, it is recommended to choose the number after 1023, which needs to be consistent with the port number defined by the server in the Raspberry Pi
'''
SERVER_PORT = 10223
BUFSIZ = 1024
...
'''
Use Tkinter's Button method to define a button, the button is on the root window, the name on the button is'ON', the text color of the button is #E1F5FE, and the background color of the button is #0277BD.
When the button is pressed, calls lights_on( )function
'''
